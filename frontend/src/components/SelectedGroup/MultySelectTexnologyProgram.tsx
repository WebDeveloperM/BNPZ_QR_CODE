...
import { GenericType, ProgramType } from '../../types/texnology';
...
export default function MultySelectTexnologyProgram({ label, selectData, selectedIdComp, selectedTexnologyId, isSubmitted }: Props) {

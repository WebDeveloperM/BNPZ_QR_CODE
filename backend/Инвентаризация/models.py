...
class MonitorDiaganal(models.Model):
    name = models.CharField(max_length=255, verbose_name='Название')
    ...
    class Meta:
        verbose_name = 'Монитор диаганал '
        verbose_name_plural = '2.6 Монитор диаганал'


# class Texnology(models.Model):
...
#     GPU = models.ForeignKey(GPU, on_delete=models.CASCADE, verbose_name='Видеокарта', null=True, blank=True, default='Нет')
#     printer = models.ForeignKey(Printer, on_delete=models.CASCADE, verbose_name='Принтер', default="Нет", null=True, blank=True)
#     scaner = models.ForeignKey(Scaner, on_delete=models.CASCADE, verbose_name='Сканер', default="Нет", null=True, blank=True)
#     type_webcamera = models.ForeignKey(TypeWebCamera, on_delete=models.CASCADE, default="Нет", verbose_name='Тип вебкамера', null=True, blank=True)
...
#     diaganal_monitor= models.ForeignKey(MonitorDiaganal, default="Нет", on_delete=models.CASCADE, verbose_name='Диаганал Монитора')
...
class Compyuter(models.Model):
    ...
    def generate_qr(self):
        ...
        if self.slug:  # Проверяем, существует ли id
            qr = qrcode.QRCode(
                version=1,

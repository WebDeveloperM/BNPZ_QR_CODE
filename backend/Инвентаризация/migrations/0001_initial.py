    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('diaganal_monitor', models.ForeignKey(default='Нет', on_delete=django.db.models.deletion.CASCADE, to='Инвентаризация.monitordiaganal', verbose_name='Диаганал Монитора')),
                ...
                ('printer', models.ForeignKey(blank=True, default='Нет', null=True, on_delete=django.db.models.deletion.CASCADE, to='Инвентаризация.printer', verbose_name='Принтер')),
                ('scaner', models.ForeignKey(blank=True, default='Нет', null=True, on_delete=django.db.models.deletion.CASCADE, to='Инвентаризация.scaner', verbose_name='Сканер')),
                ...
                ('type_monitor', models.ForeignKey(default='Нет', on_delete=django.db.models.deletion.CASCADE, to='Инвентаризация.monitor', verbose_name='Тип Монитора')),
                ('type_webcamera', models.ForeignKey(blank=True, default='Нет', null=True, on_delete=django.db.models.deletion.CASCADE, to='Инвентаризация.typewebcamera', verbose_name='Тип вебкамера')),
